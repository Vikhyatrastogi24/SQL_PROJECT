...
**Tableau** is also highly sought after, with a bold count of 6. Other skills like **R**,**Snowflake**,**Pandas**, and **Excel**
show varying degrees of demand.
...
![AVG SALARY](Assets\table_data.png)
...
![ALT TEXT](Assets\optimal_skills.png)
